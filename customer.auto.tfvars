mandant_prefix                             = "Customer A" # this is where the mandant prefix is entered
...
citrix_application_command_line_executable = "C:\\Windows\\system32\\calc.exe" # this is where the command line executable is entered
icon_path                                  = "icons/citrix.ico"                # path to the icon
