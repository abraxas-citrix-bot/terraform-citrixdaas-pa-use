citrix_application_name                    = "CMD Citrix Terraform 💡 Innovator 🎬 Showcase" #
...
citrix_deliverygroup_name                  = ["Delivery Group name"] # this is where the Delivery Group name is entered
citrix_application_visibility              = ["domain\group"]           # user or AD group this is where the visibility is entered
